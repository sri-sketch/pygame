...
class AlienInvasion:
    ...
    def _update_bullets(self):
        ...
        self._check_bullet_aline_collision()

    def _check_bullet_aline_collision(self):
        """Respond to bullet alien collision."""
        # Remove any alien and bullet that have been collided.
    ...
    def _update_screen(self):
        """Update the image on screen and flip the screen."""
        ...
        self.sb.show_score()
        # Draw the play button if the game in not active.
